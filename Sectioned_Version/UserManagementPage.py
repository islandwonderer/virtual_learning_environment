...
class UserManagementPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        suspend_label.grid(row=10, column=2, padx=10, sticky=tk.W)
        suspend_frame = tk.Frame(self)
        suspend_frame.grid(row=11, column=2, sticky=tk.NSEW, padx=10)
        ...
        pass_label.grid(row=12, column=2, padx=10, sticky=tk.W)
        self.pass_entry = tk.Entry(self, width=20, font="none 12 bold", highlightthickness=0)
        self.pass_entry.grid(row=13, column=2, padx=10)
    ...
    def update_password(self):
        self.selected_user.setCustPassword(self.pass_entry.get())
